...
SWIFT_CLASS("_TtC11SocialJoint11AppDelegate")
...
@interface CAGradientLayer (SWIFT_EXTENSION(SocialJoint))
- (CAGradientLayer * _Nonnull)turquoiseColor;
- (CAGradientLayer * _Nonnull)WhiteGrayColor;
- (CAGradientLayer * _Nonnull)IntroColor;
@end
...
SWIFT_CLASS("_TtC11SocialJoint11RadioButton")
@interface RadioButton : UIButton
@property (nonatomic, strong) CAShapeLayer * _Nonnull circleLayer;
@property (nonatomic, strong) CAShapeLayer * _Nonnull fillCircleLayer;
@property (nonatomic, strong) UIColor * _Nonnull circleColor;
@property (nonatomic, strong) UIColor * _Nonnull fillCircleColor;
@property (nonatomic) CGFloat circleLineWidth;
@property (nonatomic) CGFloat fillCircleGap;
