...
SWIFT_CLASS("_TtC14SwifterDemoiOS11AppDelegate")
...
SWIFT_CLASS("_TtC14SwifterDemoiOS18AuthViewController")
@interface AuthViewController : UIViewController <SFSafariViewControllerDelegate>
@property (nonatomic, readonly) BOOL useACAccount;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (IBAction)didTouchUpInsideLoginButton:(id _Nonnull)sender;
- (void)fetchTwitterHomeStream;
...
SWIFT_CLASS("_TtC14SwifterDemoiOS9TweetCell")
...
SWIFT_CLASS("_TtC14SwifterDemoiOS20TweetsViewController")
